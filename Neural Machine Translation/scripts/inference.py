...
from src.eval_utils import translate_sentence, run_test_evaluation
...
def display_attention(sentence_pieces, translation_pieces, attention):
    ...
    plt.savefig("assets/attention_map.png")
    print("Attention map saved as assets/attention_map.png")
...
def main():
    ...
    parser.add_argument("--model", type=str, default="../models/best_a100_model_100.pt", help="Path to model checkpoint")
    parser.add_argument("--csv", type=str, default="../data/samantar_dataset.csv", help="Path to Samantar CSV")
    parser.add_argument("--spm", type=str, default="../models/en_mr_unigram.model", help="Path to SentencePiece model")
