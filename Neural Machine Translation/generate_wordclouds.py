...
def generate_wordclouds(csv_path):
    ...
    plt.savefig('english_wordcloud.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    plt.axis('off')
    plt.tight_layout(pad=0)
    plt.savefig('marathi_wordcloud.png', dpi=300, bbox_inches='tight')
    plt.close()

    print("Success! Generated 'english_wordcloud.png' and 'marathi_wordcloud.png'.")

if __name__ == "__main__":
    generate_wordclouds("samantar_dataset.csv")
